...
const debug = require('debug')('artc:query-middleware');

module.exports = function(req, res, next){
  debug('creating page queries');
  let page = 1 ; // page index to return within a collection
  let offset = 0;
  let pagesize = 50;
  let sort = 1;
  ...
  if (req.query.sort === 'dsc') sort = -1; // sort descending
  if (req.query.sort === 'asc') sort = 1; // sort ascending
